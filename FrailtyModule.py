# -*- coding: utf-8 -*-
"""
Created on Sun Jan 16 21:10:23 2022
...
class frailtyDetector():
    ...
    def findAngle(self, img, p1, p2, p3, draw=True):
        ...
        if draw:
            ...
            cv2.line(img, (x3, y3), (x2, y2), (255, 255, 255), 9)
            ...
            cv2.putText(img, str(int(angle)), (x2 - 100, y2 + 50),
                        cv2.FONT_HERSHEY_PLAIN, 5, (0, 255, 0), 8)

            # cv2.circle(img, (face_x, face_y), 30, (255, 0, 255), cv2.FILLED)
        return angle
def main():
    cap = cv2.VideoCapture('PoseVideos/1.mp4')
    pTime = 0
    detector = frailtyDetector()
    while True:
